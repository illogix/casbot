...
//import com.illojones.web.slack.casbot.{Card, Deck}
//
///**
...
//// 1P for now
//object Blackjack1 {
//    def props(player: ActorRef, user: String) = Props(classOf[Blackjack1], player, user)
//
...
//}
//
//class Blackjack1(player: ActorRef, user: String) extends Actor {
//
//    import Blackjack1._
//
//    var dealerHand = Hand()
...
//            if (bet < Blackjack.minimum)
//                BotResponse(Some(s"Sorry, table minimum is ${Blackjack.minimum}"))
//            else {
//                self ! Blackjack.Ante(bet)
//                BotResponse(None)
//            }
//        } catch {
